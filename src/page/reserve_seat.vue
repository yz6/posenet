        ...
        <div class="contentBox rightTable">
            <el-form label-position="left" label-width="130px" :model="form">
                ...
                <el-form-item label="预约楼层">
                    <el-select @change="getDepartment" v-model="form.floorId" style="width: 200px" placeholder="请选择">
                        <el-option
...
<script>
    import {getBuilding, getFloor,getDepartment,getCurrentStaff} from "../api/getData";
        ...
        methods: {
            ...
            goMap() {
                getCurrentStaff({
                    ...
                    console.log(res)
                    console.log(this.form.type==1?1:this.form.seatNum)
